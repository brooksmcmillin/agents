...
async def get_social_media_stats(
    ...
    if platform == "twitter":
        result = {
            ...
            "account_metrics": {
                "followers": 12_450 + random.randint(-100, 300),
                "follower_growth": random.randint(-20, 150),
                "follower_growth_rate": round(random.uniform(-0.5, 2.5), 2),
                "following": 892,
            },
            "content_metrics": {
            ...
            "engagement_breakdown": {
                "likes": random.randint(800, 3_500),
                "retweets": random.randint(150, 600),
                "replies": random.randint(80, 300),
                "link_clicks": random.randint(200, 800),
                "quote_tweets": random.randint(20, 100),
            },
            "top_tweets": [
                {
                    "id": "1234567890",
                    ...
                    "engagements": random.randint(200, 600),
                    "engagement_rate": round(random.uniform(3.0, 6.0), 2),
                },
                {
                    "id": "1234567891",
                    ...
                    "engagements": random.randint(300, 800),
                    "engagement_rate": round(random.uniform(3.5, 5.5), 2),
                },
            ],
            "insights": {
        ...
        result = {
            ...
            "account_metrics": {
                "followers": 8_920 + random.randint(-50, 200),
                "follower_growth": random.randint(10, 120),
                "follower_growth_rate": round(random.uniform(0.5, 3.0), 2),
                "connections": 2_456,
            },
            "content_metrics": {
            ...
            "engagement_breakdown": {
                "reactions": random.randint(600, 2_500),
                "comments": random.randint(100, 400),
                "shares": random.randint(50, 200),
                "click_throughs": random.randint(150, 600),
            },
            "top_posts": [
                {
                    ...
                    "engagements": random.randint(300, 900),
                    "engagement_rate": round(random.uniform(3.0, 6.0), 2),
                },
                {
                    ...
                    "impressions": random.randint(12000, 30000),
                    "engagements": random.randint(400, 1000),
                    "engagement_rate": round(random.uniform(3.5, 5.5), 2),
                },
            ],
